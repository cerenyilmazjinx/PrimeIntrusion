// src/lib.rs
/*
 * Core library for PrimeIntrusion
 */
...
#[derive(Debug)]
pub struct PrimeIntrusionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeIntrusionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeIntrusion processing");
    
    let mut processor = PrimeIntrusionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeIntrusionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeIntrusionProcessor::new(false);
